  ...
  <main id="weather" class="col-md-9 container">
    ...
    <section class="mb-3 text-center" id="main-content">
      <div class="row m-0 p-0 d-flex align-items-end justify-content-center">
        <div
          class="card main col-md-4 d-flex flex-row justify-content-center align-items-center"
        >
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-center wind-speed w-25">
                  <p class="card-text ms-2">
                    ...
                    }}<span class="ml-1">m/s<span></span></span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-center w-25 pressure">
                  <p class="card-text ms-2">
                    ...
                    <span class="ms-1">hPa<span></span></span>
                  </p>
                </div>
              </div>
            </div>
      ...
      <section id="upcoming-days" class="mt-5">
        ...
        <div class="row">
          <div
            v-for="(item, i) in forecastWeatherData"
            :key="i"
            class="col my-1"
          >
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-center align-items-center">
                  ...
                  <div class="card-head">
                    <h5
                      class="card-title d-flex align-items-center text-center"
                    >
